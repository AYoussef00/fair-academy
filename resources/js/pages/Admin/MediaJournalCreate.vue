...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'إضافة مقال', href: '/admin/media-journal/create' },
];
...
<template>
    <Head title="إضافة مقال - المجلة الإعلامية" />
                    ...
                    <div class="w-full space-y-6 px-6 py-6">
                        <div class="rounded-lg border border-slate-200 bg-white px-6 py-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100">إضافة مقال للمجلة الإعلامية</h1>
                                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                        يُنشر المقال مباشرة في صفحة المجلة العلمية بعد الحفظ.
                                    </p>
                                </div>
                                <Link
                                    href="/admin/media-journal"
                        ...
                        <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <form class="mx-auto max-w-2xl space-y-5" @submit.prevent="submit">
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300">عنوان المقال *</label>
                                    <input
                                        v-model="form.title"
                                        type="text"
                                        required
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300">اسم الباحث / الكاتب *</label>
                                    <input
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300">ملخص المقال *</label>
                                    <textarea
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300">الكلمات المفتاحية *</label>
                                    <input
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300">ملف PDF *</label>
                                    <input
                                        type="file"
